...
class ProfileController extends Controller {
    ...
    public function index(Request $request) {
        ...
        return view('admin.profile.edit', $this->responceData);
    }
    ...
    public function profileUpdate(Request $request) {
        try {
            ...
            if ($validator->fails()) :
                ...
                $phoneNumberExsist = User::where('id', '!=', Auth::guard('admin')->user()->id)
    ...
    public function profileImageUpdate($slug,Request $request) {
        try {
            ...
            $this->responceData['profileImage']= ProfileImage::where('user_id', Auth::guard('admin')->user()->id)->get();

            return view('admin.profile.profile-image-add', $this->responceData);
    ...
    public function setDemoProfilePicture(Request $request) {
     ...
     public function deleteProfilePicture($id,Request $request) {
        ...
        $user=User::where('id', Auth::guard('admin')->user()->id)->get();
        $profilePicture=User::where('id', Auth::guard('admin')->user()->id)->get("profile_picture_url");


        $imageExists=count(ProfileImage::where('user_id',Auth::guard('admin')->user()->id)->get());
