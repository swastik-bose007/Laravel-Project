...
class ProfileController extends Controller {
    ...
    public function index(Request $request) {
        $this->responceData['produceCount'] = Produce::where('created_by', Auth::guard('fpo')->user()->id)->count();

        return view('fpo.profile.edit', $this->responceData);
    }
    ...
    public function profileUpdate(Request $request) {
        try {
            ...
            if ($validator->fails()) :
                ...
                $phoneNumberExsist = User::where('id', '!=', Auth::guard('fpo')->user()->id)
    ...
    public function changePassword(Request $request) {
        try {
            ...
            if ($validator->fails()) :
                ...
                if (!(Hash::check($request->current_password, Auth::guard('fpo')->user()->password))) :
    ...
    public function profileImageUpdate($slug,Request $request) {
        try {
            ...
            $this->responceData['profileImage']= ProfileImage::where('user_id', Auth::guard('fpo')->user()->id)->get();

            return view('fpo.profile.profile-image-add', $this->responceData);
    ...
    public function setProfilePicture($slug, Request $request) {
        try {
            $user=User::where('id', Auth::guard('fpo')->user()->id)->get();
    ...
    public function setDemoProfilePicture(Request $request) {
     ...
     public function deleteProfilePicture($id,Request $request) {
        ...
        $user=User::where('id', Auth::guard('fpo')->user()->id)->get();
        $profilePicture=User::where('id', Auth::guard('fpo')->user()->id)->get("profile_picture_url");


        $imageExists=count(ProfileImage::where('user_id',Auth::guard('fpo')->user()->id)->get());
