        ...
        <div class="login-box">
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <form id="loginForm" name="loginForm" autocomplete="off" enctype="multipart/form-data" method="post" action="{{ url('/administration/login') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-12">
                    ...
                    <p class="mb-1">
                        <a href="{{ url('administration/forgot-password') }}">I forgot my password</a>
                    </p>
                </div>
                <!-- /.card-body -->
            </div>
