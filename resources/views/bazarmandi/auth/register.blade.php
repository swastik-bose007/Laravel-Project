...
<html lang="en">
    <head>
        ...
        <title>{{ env('APP_NAME') }} | Bazar Mandi Register</title>
                ...
                <div class="col-12">
                    <div class="card card-outline card-primary mx-auto mt-4 mb-4" style="max-width: 600px;">
                        <div class="card-header text-center">
                            <a href="{{ url('bazarmandi/login') }}" class="h1"><b>{{ env('APP_NAME') }}</b></a>
                        </div>
                        <div class="card-body">
                            <p class="login-box-msg">Bazar Mandi Register</p>

                            @include('bazarmandi.includes.alert-message')
                            
                            <form id="registerForm" name="registerForm" autocomplete="off" enctype="multipart/form-data" method="post" action="{{ url('/bazarmandi/register') }}">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="bazar_mandi_name" class="form-control" value="{{ old('bazar_mandi_name') }}" placeholder="Enter bazar mandi name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="bazar_mandi_type" class="form-control">
                                                <option value="big" {{ old('bazar_mandi_type') == 'big' ? 'selected' : ''}}>Big</option>
                                                <option value="small" {{ old('bazar_mandi_type') == 'small' ? 'selected' : ''}}>Small</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <a href="{{ url('bazarmandi/login') }}">Login</a>
                                    </div>
                                    <!-- /.col -->
                                    <div class="col-4">
