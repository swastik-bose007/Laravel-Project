...
<html lang="{{ app()->getLocale() }}" dir="ltr">
    <head>
        @include('bazarmandi.includes.head')
    </head>
    ...
    <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        <div class="wrapper">
            ...
            <!-- Navbar -->
            @include('bazarmandi.includes.header')
            <!-- /.navbar -->

            <!-- Main Sidebar Container -->
            @include('bazarmandi.includes.left-menu')
            ...
            <!-- Main Footer -->
            @include('bazarmandi.includes.footer')
        </div>
        <!-- ./wrapper -->
        ...
        <script>
            function logout() {
                swal("Do you want to logout ?", {
                    ...
                    if(value) {
                        redirect("{{ url('bazarmandi/logout') }}");
                    }
                });
            }
