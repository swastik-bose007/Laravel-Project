...
<html lang="en">
    <head>
        ...
        <title>{{ env('APP_NAME') }} | Developer Login</title>
        ...
        <div class="login-box">
            ...
            <div class="card card-outline card-primary">
                <div class="card-header text-center">
                    <a href="{{ url('developer/login') }}" class="h1"><b>{{ env('APP_NAME') }}</b></a>
                </div>
                <div class="card-body">
                    ...
                    <form id="loginForm" name="loginForm" autocomplete="off" enctype="multipart/form-data" method="post" action="{{ url('developer/login') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-12">
                    ...
                    <p class="mb-1">
                        <a href="{{ url('developer/forgot-password') }}">I forgot my password</a>
                    </p>
                </div>
                <!-- /.card-body -->
            </div>
