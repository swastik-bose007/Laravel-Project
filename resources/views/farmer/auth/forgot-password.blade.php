...
<html lang="en">
    <head>
        ...
        <title>{{ env('APP_NAME') }} | Farmer Login</title>
        ...
        <div class="login-box">
            <div class="card card-outline card-primary">
                <div class="card-header text-center">
                    <a href="{{ url('farmer/forgot-password') }}" class="h1"><b>{{ env('APP_NAME') }}</b></a>
                </div>
                <div class="card-body">
                    <p class="login-box-msg">Farmer Forgot Password</p>
                    
                    @include('farmer.includes.alert-message')
                    
                    <form id="forgotPasswordForm" name="forgotPasswordForm" autocomplete="off" enctype="multipart/form-data" method="post" action="{{ url('/farmer/forgot-password') }}">
                        {{ csrf_field() }}
