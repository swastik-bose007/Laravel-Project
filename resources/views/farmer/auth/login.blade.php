        ...
        <div class="login-box">
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <form id="loginForm" name="loginForm" autocomplete="off" enctype="multipart/form-data" method="post" action="{{ url('/farmer/login') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-12">
                    ...
                    <p class="mb-1">
                        <a href="{{ url('farmer/forgot-password') }}">I forgot my password</a>
                    </p>

                    <p class="mb-1">
                        <a href="{{ url('farmer/register') }}">Register</a>
                    </p>
                </div>
                <!-- /.card-body -->
            </div>
