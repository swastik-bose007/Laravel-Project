                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">
                            <a href="{{ url('farmer/produce/list') }}">
                                Produce
                            </a>
                        </li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="updateForm" name="updateForm" autocomplete="off" enctype="multipart/form-data" method="post" action="{{ url('farmer/produce/update') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $produce->getProduceName->getCategory->name }}" class="form-control" name="category" id="category" readonly />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                       <div class="col-sm-6">
                                           <div class="form-group">
                                                ...
                                                <input type="text" value="{{ $produce->quantity }}" class="form-control" name="quantity" placeholder="Enter Quantity">
                                          </div>
                                    </div>
                                        <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="last_name">Type</label>
                                                    <input type="text" value="{{ $produce->type }}" class="form-control" name="type" placeholder="Enter type">
                                                </div>
                                       </div>
                                </div>
                            </div>
