...
<html lang="en">
    <head>
        ...
        <title>{{ env('APP_NAME') }} | FPO Login</title>
        ...
        <div class="login-box">
            <div class="card card-outline card-primary">
                <div class="card-header text-center">
                    <a href="{{ url('fpo/forgot-password') }}" class="h1"><b>{{ env('APP_NAME') }}</b></a>
                </div>
                <div class="card-body">
                    <p class="login-box-msg">FPO Forgot Password</p>
                    
                    @include('fpo.includes.alert-message')
                    
                    <form id="forgotPasswordForm" name="forgotPasswordForm" autocomplete="off" enctype="multipart/form-data" method="post" action="{{ url('/fpo/forgot-password') }}">
                        {{ csrf_field() }}
