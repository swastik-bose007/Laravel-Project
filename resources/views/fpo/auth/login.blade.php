    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <p class="login-box-msg">FPO Login</p>

                    @include('fpo.includes.alert-message')
                    
                    <form id="loginForm" name="loginForm" autocomplete="off" enctype="multipart/form-data" method="post" action="{{ url('/fpo/login') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-12">
                    ...
                    <p class="mb-1">
                        <a href="{{ url('fpo/forgot-password') }}">I forgot my password</a>
                    </p>

                    <p class="mb-1">
                        <a href="{{ url('fpo/register') }}">Register</a>
                    </p>
                </div>
                <!-- /.card-body -->
            </div>
