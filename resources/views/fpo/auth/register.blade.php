...
<html lang="en">
    <head>
        ...
        <title>{{ env('APP_NAME') }} | FPO Register</title>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-outline card-primary mx-auto mt-4 mb-4" style="max-width: 600px;">
                        ...
                        <div class="card-body">
                            <p class="login-box-msg">FPO Register</p>

                            @include('fpo.includes.alert-message')
                            
                            <form id="registerForm" name="registerForm" autocomplete="off" enctype="multipart/form-data" method="post" action="{{ url('/fpo/register') }}">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="content_title">CIN No</label>
                                            <input type="text" name="cin_no" class="form-control" value="{{ old('cin_no') }}" placeholder="Enter cin no">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="content_title">Registration No</label>
                                            <input type="text" name="registration_no" class="form-control" value="{{ old('registration_no') }}" placeholder="Enter registration no">
                                        </div>
                                    </div>
                                </div>
