...
<html lang="en">
    <head>
        ...
        <title>{{ env('APP_NAME') }} | Sufal Store Login</title>
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <p class="login-box-msg">Sufal Store Login</p>

                    @include('sufalstore.includes.alert-message')
                    
                    <form id="loginForm" name="loginForm" autocomplete="off" enctype="multipart/form-data" method="post" action="{{ url('/sufalstore/login') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-12">
                    ...
                    <p class="mb-1">
                        <a href="{{ url('sufalstore/forgot-password') }}">I forgot my password</a>
                    </p>

                    <p class="mb-1">
                        <a href="{{ url('sufalstore/register') }}">Register</a>
                    </p>
                </div>
                <!-- /.card-body -->
            </div>
