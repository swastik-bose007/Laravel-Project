    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <p class="login-box-msg">Sufal Store Reset Password</p>
                    
                    @include('sufalstore.includes.alert-message')
                    
                    <form id="forgotPasswordForm" name="forgotPasswordForm" autocomplete="off" enctype="multipart/form-data" method="post" action="{{ url('/sufalstore/forgot-password') }}">
                        {{ csrf_field() }}
