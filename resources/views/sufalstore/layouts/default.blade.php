...
<html lang="{{ app()->getLocale() }}" dir="ltr">
    <head>
        @include('sufalstore.includes.head')
    </head>
    ...
    <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        <div class="wrapper">
            ...
            <div class="preloader flex-column justify-content-center align-items-center">
                <img class="animation__wobble" src="{{ url('public/theme/admin/dist/img/kridarplogo.png') }}" alt="kridarplogo.png" height="60" width="60">
            </div>

            <!-- Navbar -->
            @include('sufalstore.includes.header')
            <!-- /.navbar -->

            <!-- Main Sidebar Container -->
            @include('sufalstore.includes.left-menu')
            ...
            <!-- Main Footer -->
            @include('sufalstore.includes.footer')
        </div>
        <!-- ./wrapper -->
        ...
        <script>
            function logout() {
                swal("Do you want to logout ?", {
                    ...
                    if(value) {
                        redirect("{{ url('sufalstore/logout') }}");
                    }
                });
            }
