                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">
                            <a href="{{ url('sufalstore/produce/list') }}">
                                Produce
                            </a>
                        </li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="updateForm" name="updateForm" autocomplete="off" enctype="multipart/form-data" method="post" action="{{ url('sufalstore/produce/update') }}">
...
$(document).ready(function() {
    ...
    $("#produce_name_id").change(function() {
        ...
        if(typeof categoryName == "undefined") {
            ...
            $.ajax({
                type:'GET',
                url:'<?php echo url("sufalstore/produce/get-produce-name-variant"); ?>/' + slug,
                data:'',
