...
use App\Http\Middleware\IsSufalstoreLogin;
use App\Http\Middleware\IsSufalstoreLogout;
...
Route::group(['namespace' => 'Sufalstore', 'middleware' => [IsSufalstoreLogout::class]], function () {
...
Route::group(['namespace' => 'Sufalstore', 'middleware' => [IsSufalstoreLogin::class]], function() {
